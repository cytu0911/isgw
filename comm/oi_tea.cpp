...
版本更新历史
	...
	JediHuang 2000年8月25日：

		修正oi_symmetry_decrypt2和oi_symmetry_decrypt函数;
...
/*密文格式:PadLen(1char)+Padding(var,0-7char)+Salt(2char)+Body(var char)+Zero(8char)*/
...

{
	...
	nPadSaltBodyZeroLen = nInBufLen/*Body长度*/+1+SALT_LEN+ZERO_LEN/*PadLen(1char)+Salt(2char)+Zero(8char)*/;
